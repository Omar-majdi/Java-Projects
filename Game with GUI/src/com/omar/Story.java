...
public class Story {
    ...
    public void defaultSetup() {
        ...
        player.hp = 10;
        ui.hpNumberLapel.setText("" + player.hp);

        player.currentWeapon = new Weapon_Knife();
        ui.weaponNameLapel.setText(player.currentWeapon.name);
    ...
    public void townGate() {
        ...
        game.nextPosition1 = "Talk Guard";
        game.nextPosition2 = "Attack Guard";
        game.nextPosition3 = "Cross Road";
        game.nextPosition4 = "";
    }
    ...
    public void talkGuard() {
        ...
        if (silverRing == 0) {
            ui.mainTextArea.setText("Guard: Hello there stranger. I have never seen your face.  Sorry but we cannot let stranger enter our town.");
            ui.choice1.setText(">");
            ui.choice2.setText("");
            ui.choice3.setText("");
            ui.choice4.setText("");
    ...
    public void attackGuard() {
        ui.mainTextArea.setText("Guard: you are brave, but in the wrong place. The guard attacked you and you gave up \n (You receive 3 damage)");
    ...
    public void crossRoad() {
        ui.mainTextArea.setText("Ypu are at the crossroad.\n If you go south, you will go back to the town.");
        ...
        game.nextPosition3 = "town Gate";
        game.nextPosition4 = "west";
    }

    public void north() {
        ui.mainTextArea.setText("There is a river.\n You drink water and take a rest at the riverside.\n\n(Your HP is recovered by 2)");
    ...
    public void playerAttack() {
        ...
        ui.mainTextArea.setText("You attacked the " + monster.name + " and gave " + playerDamage);
